  ...
  render() {
    ...
    var styles = {
      ...
      card: {
        ...
        // boxShadow:
        //   "0 25px 50px rgba(50,50,93,.05), 0 7px 15px rgba(50,50,93,.1), 0 5px 5px rgba(0,0,0,.1)",
        transition: "0.3s",
        ...
        borderRadius: "2px" /* 5px rounded corners */,
        flex: 1
      },
      cardContainer: {
        marginLeft: "100px",
        ...
        marginBottom: "10em",
        zIndex: "2",
        maxWidth: this.props.isMobile ? "200vh" : "1200px",
        flex: "1",
        flexDirection: "row"
      },
      titleText: {
      ...
      contentContainer: {
        ...
        maxWidth: this.props.isMobile ? "100vh" : "1000px"
      },
      mediaContainer: {
        position: "relative",
        left: "-5em",
    ...
    return (
      <Flexbox
        ...
        maxWidth={this.props.isMobile ? "90vw" : "1200px"}
        width={this.props.isMobile ? "100%" : "80vw"}
      >
        <Flexbox style={styles.card} flexDirection="column">
          <Flexbox style={styles.containers}>
            {!this.props.isMobile && (
              <Flexbox flexDirection="column" style={styles.mediaContainer}>
                {this.props.topLeftVideo &&
                  !this.props.phoneScreen && (
                    <iframe
                      src={this.props.topLeftVideo}
                      frameBorder="0"
                ...
                {this.props.bottomLeftImage &&
                  !this.props.phoneScreen && (
                    <SlideShow
                      photos={this.props.bottomLeftImage}
                      style={styles.photoBottomLeft}
                      chosenColor={this.props.mainColor}
                    />
                  )}
                {this.props.phoneScreen && (
                  <SlideShow
                    photos={this.props.phoneScreen}
            ...
            <Flexbox flexDirection="column" style={styles.contentContainer}>
              <Flexbox style={styles.titleText}>{this.props.title}</Flexbox>
              <Flexbox
              ...
              <TechBoxes
                techArray={this.props.techArray}
                style={styles.techs}
                boxStyle={styles.techBox}
              />
        ...
        {(this.props.demoLink ||
          ...
          >
            {this.props.gitLink && (
              <a href={this.props.gitLink} target="_blank" style={styles.aLink}>
                <Flexbox flexDirection="column" style={styles.linkContainer}>
                  <GitCircle style={styles.links} />
                  <Flexbox style={styles.linkText}>Code</Flexbox>
                </Flexbox>
              </a>
            )}
            {this.props.demoLink && (
              ...
              >
                <Flexbox flexDirection="column" style={styles.linkContainer}>
                  ...
                  <Flexbox style={styles.linkText}>Demo</Flexbox>
                </Flexbox>
              </a>
            )}
            {this.props.reportLink && (
              ...
              >
                <Flexbox flexDirection="column" style={styles.linkContainer}>
                  ...
                  <Flexbox style={styles.linkText}>Report</Flexbox>
                </Flexbox>
              </a>
            )}
            {this.props.exSiteLink && (
              <a
                href={this.props.exSiteLink}
                target="_blank"
                style={styles.aLink}
              >
                <Flexbox flexDirection="column" style={styles.linkContainer}>
                  <Site style={styles.links} />
                  <Flexbox style={styles.linkText}>{this.props.exSite}</Flexbox>
                </Flexbox>
              </a>
            )}
          </Flexbox>
